...
function renderWeather(d){
  ...
  heroStat('hs-pressure', 'pressure', c.surface_pressure.toFixed(1)+' hPa', 'Basınç');
  heroStat('hs-visibility', 'visibility', c.visibility>=1000 ? (c.visibility/1000).toFixed(1)+' km' : c.visibility+' m', 'Görünürlük');
